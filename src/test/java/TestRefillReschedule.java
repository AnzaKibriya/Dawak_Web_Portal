...
public class TestRefillReschedule extends BaseClass {
    ...
    @Test(priority = 37)
    public void rescheduleOrder() throws InterruptedException {

        test = extent.createTest("Reschedule Order");
        Pages.OrderDetailsCallCentre().rescheduleDelivery();
        Pages.WebCommon().waitForLoaderInvisibility();
    }
    @Test(priority = 37)
    public void verifyLogoutFunctionCallCentre() throws InterruptedException {
        test = extent.createTest("Logout Functionality");
        Pages.WebCommon().waitForElementsInteractions();
        Pages.Logout().verifyLogout();
        Pages.WebCommon().waitForElementsInteractions();
    ...
    @Test(priority =38 )
    public void verifyDPLoginFunction() {
        test = extent.createTest("Login to DP Portal");
        Pages.LoginDP().DPLogin();
        Pages.LoginDP().verifyEnteringOtp();
    ...
    @Test(priority = 39)
    public void verifyOrderInTOdoDispensingPortal() throws InterruptedException, FileNotFoundException {
        test = extent.createTest("Verify Making Order In TODO");
        Pages.HomeDP().verifyHomePageHeader();
    ...
    @Test(priority = 40)
    public void verifyOrderInProgressDispensing() throws InterruptedException {
        test = extent.createTest("Verify Making Order In InProgressTAB");
        Pages.NavigationsDP().navigateTOInprogressTab();
        Pages.HomeDP().moveToInprogressandVerify();
        Pages.HomeDP().clickonDetailButtonInInprogressTab();
    ...
    @Test(priority = 42)
    public void verifyOrderDispensingPortal() throws InterruptedException {
        test = extent.createTest("Verify Making Order In Dispensing TAB");
        Pages.OrderDetailsDP().dispensingOrder();
        Pages.NavigationsDP().navigateTODispensingInProgressTab();
        Pages.HomeDP().searchOrderInDispensingInProgress();
    ...
    @Test(priority = 43)
    public void verifyPatientInformationDispensingOrder() throws FileNotFoundException, InterruptedException {
        test = extent.createTest("Verify Patient Information Dispensing Order Tab");
        Pages.WebCommon().waitForElementsInteractions();
        Pages.OrderDetailsDP().orderReadyForDelivery();
    }
    ...
    @Test(priority = 44)
    public void verifyDeliveryFunctionalityDispensing() throws InterruptedException, FileNotFoundException {
        test = extent.createTest("Verify Making Order In  Ready for Delivery TAB");

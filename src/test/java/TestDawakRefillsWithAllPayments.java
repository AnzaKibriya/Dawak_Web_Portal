...
public class TestDawakRefillsWithAllPayments extends BaseClass {

    @Test(priority = 1)
    public void createNewRefills() throws InterruptedException {
        test = extent.createTest("create a new Refills");
        accessToken = LoginApiCall.makeLoginApiCall();
        refillsOrderID = generateRandomNumericString();
        System.out.println(refillsOrderID);
        //  NewPatientApiCall.makeCreatePatientApiCall(accessToken, prescriptionOrderID);
        RefillApiCall.makeRefillApiCall(accessToken, refillsOrderID);
        Thread.sleep(10000);
    }

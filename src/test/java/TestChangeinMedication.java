...
public class TestChangeinMedication extends BaseClass {
    ...
    @Test(priority = 19)
    public void verifyInsurenceReschedule() throws InterruptedException {
        test = extent.createTest("verify Insurence Reschedule");
       InsurenceRescheduleAPI.rescheduleAPIcall();

...
public class RefillApiCall {
    private static final String API_URL = "https://dawak-apim-uat.azure-api.net/dawak-portal/api/prescription/detail";

    public static void makeRefillApiCall(String AUTH_TOKEN, String orderID) {
        try {
            MediaType mediaType = MediaType.parse("application/json");
            Gson gson = new Gson();
            RefillApiCall makeRefillApiCall = new RefillApiCall();
            String jsonPayload = gson.toJson(makeRefillApiCall.getRefillRequest(orderID));
    ...
    public PrescriptionRequest getRefillRequest(String orderID) {
